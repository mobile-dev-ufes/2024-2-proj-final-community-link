...
class SpinnerAdapter(context: Context, private val items: List<String>) :
    ArrayAdapter<String>(context, R.layout.layout_spinner_item, items) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (position == 0) binding.text.setTextColor(context.getColor(R.color.gray))
        else binding.text.setTextColor(context.getColor(R.color.black))
